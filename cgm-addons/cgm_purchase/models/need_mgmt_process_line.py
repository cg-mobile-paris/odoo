...
class NeedMgmtProcessLine(models.Model):
    ...
    qty_available = fields.Float('Physical Qty', readonly=True)
    virtual_available = fields.Float('Available Qty', readonly=True)
    qty_projected = fields.Float('Projected Qty', readonly=True)
